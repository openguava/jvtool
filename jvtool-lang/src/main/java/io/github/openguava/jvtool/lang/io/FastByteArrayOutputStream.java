package io.github.openguava.jvtool.lang.io;
...
public class FastByteArrayOutputStream extends OutputStream {
	...
	public FastByteArrayOutputStream(int initialBlockSize) {
		Validate.isTrue(initialBlockSize > 0, "Initial block size must be greater than 0");
	...
	public void resize(int targetCapacity) {
		Validate.isTrue(targetCapacity >= size(), "New capacity must not be smaller than current size");
