...
import io.github.openguava.jvtool.lang.mutable.MutableInt;
...
public class Base64Decoder {
	...
	public static String decodeStr(CharSequence source) {
		return decodeStr(source, CharsetConstants.CHARSET_DEFAULT);
	}
	...
	public static byte[] decode(CharSequence source) {
		return decode(StringUtils.toBytes(source, CharsetConstants.CHARSET_DEFAULT));
	}
