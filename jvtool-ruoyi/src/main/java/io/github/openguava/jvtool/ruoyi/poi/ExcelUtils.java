...
import io.github.openguava.jvtool.lang.util.FileUtils;
import io.github.openguava.jvtool.lang.util.ImageUtils;
...
import io.github.openguava.jvtool.ruoyi.poi.annotation.Excel;
import io.github.openguava.jvtool.ruoyi.poi.annotation.Excels;
import io.github.openguava.jvtool.ruoyi.poi.annotation.Excel.ColumnType;
import io.github.openguava.jvtool.ruoyi.poi.annotation.Excel.Type;
...
public class ExcelUtils<T> {
    ...
    {
        return importExcel(StringUtils.STRING_EMPTY, is, titleNum);
    }
            ...
            for (int i = titleNum + 1; i <= rows; i++)
            {
                ...
                for (Map.Entry<Integer, Object[]> entry : fieldsMap.entrySet())
                {
                    ...
                    if (StringUtils.isNotNull(fieldType))
                    {
                        ...
                        ReflectUtils.invokeSetterMethod(entity, propertyName, val);
                    }
                }
                list.add(entity);
            }
    ...
    {
        exportExcel(response, list, sheetName, StringUtils.STRING_EMPTY);
    }
    ...
    {
        importTemplateExcel(response, sheetName, StringUtils.STRING_EMPTY);
    }
    ...
    public void exportExcel(HttpServletResponse response)
    {
        ...
        {
            LogUtils.error(ExcelUtils.class, "导出Excel异常{}", e.getMessage());
        }
        finally
        {
            ...
            for (Object[] os : fields)
            {
                ...
                if (Collection.class.isAssignableFrom(field.getType()) && StringUtils.isNotNull(subList))
                {
                    ...
                    for (Object obj : subList)
                    {
                        ...
                        List<Field> subFields = ReflectUtils.getFieldsListWithAnnotation(obj.getClass(), Excel.class);
                        int subIndex = 0;
                        for (Field subField : subFields)
                        {
    ...
    public void setCellVo(Object value, Excel attr, Cell cell)
    {
        if (ColumnType.STRING == attr.cellType())
        {
            ...
            {
                cellValue = StringUtils.STRING_EMPTY;
            }
        ...
        else if (ColumnType.IMAGE == attr.cellType())
        {
            ...
            {
            	try {
            		byte[] data = FileUtils.readBytes(imagePath);
                    getDrawingPatriarch(cell.getSheet()).createPicture(anchor,
                            cell.getSheet().getWorkbook().addPicture(data, getImageType(data)));
				} catch (IOException e) {
					LogUtils.error(ExcelUtils.class, e.getMessage(), e);
				}
            }
        }
    }
    ...
    {
        String type = ImageUtils.getImageFileExtendName(value);
    ...
    public Cell addCell(Excel attr, Row row, T vo, Field field, int column)
    {
        ...
        {
            LogUtils.error(ExcelUtils.class, "导出Excel失败{}", e);
        }
        return cell;
    }
    ...
    public String dataFormatHandlerAdapter(Object value, Excel excel)
    {
        ...
        {
            LogUtils.error(ExcelUtils.class, "不能格式化数据 " + excel.handler(), e.getMessage());
        }
            ...
            if (!ArrayUtils.contains(this.excludeFields, field.getName()))
            {
                ...
                if (field.isAnnotationPresent(Excel.class))
                {
                    ...
                    if (Collection.class.isAssignableFrom(field.getType()))
                    {
                        ...
                        this.subFields = ReflectUtils.getFieldsListWithAnnotation(subClass, Excel.class);
                    }
                }
    ...
    public String parseDateToStr(String dateFormat, Object val)
    {
        ...
        {
            str = DateUtils.format(DateUtils.toDate((LocalDateTime) val), dateFormat);
        }
        else if (val instanceof LocalDate)
        {
            str = DateUtils.format(DateUtils.toDate((LocalDate) val), dateFormat);
        }
        else
        {
            str = val.toString();
    ...
    public Method getSubMethod(String name, Class<?> pojoClass)
    {
        ...
        {
            LogUtils.error(ExcelUtils.class, "获取对象异常{}", e.getMessage());
        }
        return method;
    }
}